...
class WormDomainCreateParams(object):
    ...
    def __init__(self, autocommit_offset=None, default_retention=None, max_retention=None, min_retention=None, override_date=None, privileged_delete=None, type=None, path=None):  # noqa: E501
